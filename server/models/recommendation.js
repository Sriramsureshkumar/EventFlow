...
const { sendRecommendationsEmail } = require("../controllers/smsController"); // Import the new function
...
const recommendations = async (req, res) => {
    try {
        ...
        // Send recommendations email to the user
        sendRecommendationsEmail(userEmail, recommendedEvents);

        // Return recommendations for the current user in response
